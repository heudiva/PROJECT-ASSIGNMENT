...
<title>Tailwind CSS Maintenance Page - Flowbite</title>

<link rel="canonical" href="http://localhost:1313/pages/maintenance/">
...
<!-- Facebook -->
<meta property="og:url" content="http://localhost:1313/pages/maintenance/">
...
<div class="flex flex-col justify-center items-center px-6 mx-auto h-screen xl:px-0 dark:bg-gray-900">
    <div class="block mb-5 md:max-w-md">
        <img src="http://localhost:1313/images/illustrations/maintenance.svg" alt="maintenance image">
    </div>
