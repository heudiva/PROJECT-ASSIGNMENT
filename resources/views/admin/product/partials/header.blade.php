...
<!-- Add include supplier in header @@include('admin.supplier.create') -->
        <button type="button" data-modal-backdrop="false" data-modal-target="add-user-modal" data-modal-toggle="add-user-modal" data-drawer-show="add-user-modal" aria-controls="add-user-modal" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
