...
@endphp
    <main>
        <!-- Header User Table -->
        @include('admin.users-info.header')

        <div class="flex flex-col">
            <div class="overflow-x-auto">
                <div class="inline-block min-w-full align-middle">
                    <div class="overflow-hidden shadow">
                        <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600" id="user-table-body">
                            ...
                            <tbody id="myTable" class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white ">{{ $user->created_at->format('j-F-y') }}</td>
        ...
        <!-- Edit User Modal -->
        @include('admin.users-info.edit')
        
        <!-- Add User Modal -->
        @include('admin.users-info.create')
        
        
        <!-- Delete User Modal -->
        @include('admin.users-info.delete')
