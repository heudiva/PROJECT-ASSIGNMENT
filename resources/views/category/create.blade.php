 <!-- Add Product Drawer -->
<div id="drawer-create-product-default" class="fixed border border-gray-500 top-0 right-0 z-50 w-full h-screen max-w-sm p-4 overflow-y-auto transition-transform translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-label" aria-hidden="true">
...
<script>
    $(document).ready(function() {
        $('#SubmitForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('category.store') }}",  // Use Laravel route helper
                type: "POST",
